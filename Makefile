...
# Generated by qmake (2.01a) (Qt 4.8.7) on: mar apr 16 14:58:15 2019
# Project:  QtDSO.pro
# Template: subdirs
# Command: /usr/bin/qmake-qt4 -o Makefile QtDSO.pro
#############################################################################
...
src/$(MAKEFILE): 
	...
	cd src/ && $(QMAKE) /home/julian/Downloads/qtdso/QtDSO-0.3.1/src/src.pro -o $(MAKEFILE)
...
Makefile: QtDSO.pro  /usr/share/qt4/mkspecs/linux-g++/qmake.conf /usr/share/qt4/mkspecs/common/unix.conf \
